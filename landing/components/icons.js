/**
 * Unified line-icon system — single stroke weight across landing.
 */

const ICONS = {
  play:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="9 6 18 12 9 18 9 6"/></svg>',
  "chevron-left":
...
/**
 * @param {"play"|"chevron-left"|"chevron-right"|"check"|"chevron-down"} name
